...
def scan_cmd(
    ...
    from gcode_index.folder_tree_map import load_folder_tree_map, tree_map_path_for_target
    from gcode_index.odbiorca_aliases import OdbiorcaAliasMap, odbiorcy_path_for_target
