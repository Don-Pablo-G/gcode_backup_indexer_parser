...
STRINGS: dict[str, dict[str, str]] = {
    "pl": {
        ...
        "scan_note_flags": '; flagi zielone={green} żółte={yellow}',
        ...
        "duplicates_summary": '{exact} grup SHA, {near} grup podobnych. Wybierz grupę, potem Pokaż w wynikach.',
        "dup_kind_exact": 'SHA',
    ...
    "en": {
        ...
        "scan_note_flags": '; flags green={green} yellow={yellow}',
        ...
        "duplicates_summary": '{exact} exact SHA group(s), {near} near-duplicate group(s). Select a group, then Show in results.',
        "dup_kind_exact": 'SHA',
        "dup_kind_near": 'Near',
        "col_sha": 'SHA-256',
